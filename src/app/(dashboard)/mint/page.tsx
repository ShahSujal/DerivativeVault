...
import MintTokenForm from '@/components/pages/mint/mintTokenForm';
import OptionsMinter from '@/components/pages/mint/OptionsMinter'
  ...
  const fetchUserPositions = async () => {
    ...
    useEffect(() => {
     ...
     // Mint options function
      const mintOptions = async (positionId: string, optionType: "CALL" | "PUT", strike: number, expiry: number, assetIndex: number) => {
