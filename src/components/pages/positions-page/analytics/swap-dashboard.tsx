...
export function SwapsDashboard({realPrice, tokenSymbol1, tokenSymbol2}:Props) {
  ...
  const currentPool = realPrice.data.pools.find((pool) => pool.id === selectedPool)
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <StatsCard
          ...
          value={sqrtPriceX96ToPrice(BigInt(realPrice.data.pools[0].sqrtPrice)).toFixed(2).toString()}
